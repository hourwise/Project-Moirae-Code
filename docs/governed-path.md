...
| 9. Tool runner executes scoped action                   | Tool, Git, shell, or MCP action executes through a narrow broker       | Git adapter and sandbox execution are placeholders; no generic tool runner is implemented here                                         | Not implemented                         |
...
| External CLIs                           | No            | Governed tool runner and command sandbox                                       | Supervisor spawn code is stubbed                                 |
